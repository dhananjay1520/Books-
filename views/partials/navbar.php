...
<?php $nav_wishlist_ids=$this->session->userdata('wishlist_ids');if(!is_array($nav_wishlist_ids))$nav_wishlist_ids=[];$nav_wishlist_count=count(array_filter(array_map('intval',$nav_wishlist_ids)));$nav_cart_count=isset($cartCount)?(int)$cartCount:0; ?>
<header class="book-navbar">
    <div class="book-top">
        ...
        <div class="book-actions">
            <a href="<?= site_url('cart'); ?>" class="book-icon-link" aria-label="Shopping cart"><i class="fa-solid fa-bag-shopping"></i><span class="book-cart-count" id="cartCount"><?php echo htmlspecialchars($nav_cart_count); ?></span></a>
            
            <a href="<?= site_url('wishlist'); ?>" class="book-icon-link" aria-label="Wishlist"><i class="fa-solid fa-heart"></i><span class="book-cart-count wishlist-count" id="wishlistCount"><?php echo $nav_wishlist_count; ?></span></a>
    ...
    <nav class="book-nav"><div class="book-nav-inner"><a href="<?= site_url('home'); ?>">Home</a><a href="<?= site_url('category'); ?>">Categories</a><a href="<?= site_url('myebook'); ?>">eBooks</a><a href="<?= site_url('about'); ?>">About Us</a><a href="<?= site_url('contact'); ?>">Contact</a><a href="<?= site_url('help'); ?>">Help</a></div></nav>
</header>
...
<aside class="book-sidebar" id="bookSidebar" aria-label="Quick navigation">
    ...
    <div class="side-group"><div class="side-label">Account</div>
        ...
        <a class="side-link" href="<?= site_url('wishlist'); ?>"><i class="fa-solid fa-heart"></i> Wishlist <span style="margin-left:auto" class="wishlist-count-side"><?php echo $nav_wishlist_count; ?></span></a>
        <a class="side-link" href="<?= site_url('contact'); ?>"><i class="fa-regular fa-envelope"></i> Contact</a><a class="side-link" href="<?= site_url('help'); ?>"><i class="fa-solid fa-circle-question"></i> Help</a>
    </div>
</aside>
<script>
