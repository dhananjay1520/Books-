                ...
                <?php foreach ($bestsellers as $product): ?>
                    <article class="bs-card">
                        <div class="bs-card-box">
                            ...
                            <button class="bs-heart wishlist-toggle <?= !empty($wishlistStatusBestsellers[$product['id']]) ? 'is-wishlisted' : ''; ?>" type="button" data-product-id="<?= (int)$product['id']; ?>" aria-label="<?= !empty($wishlistStatusBestsellers[$product['id']]) ? 'Remove from wishlist' : 'Add to wishlist'; ?>" aria-pressed="<?= !empty($wishlistStatusBestsellers[$product['id']]) ? 'true' : 'false'; ?>"><i class="<?= !empty($wishlistStatusBestsellers[$product['id']]) ? 'fa-solid' : 'fa-regular'; ?> fa-heart"></i></button>
