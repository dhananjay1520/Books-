...
/* DataTables - keep native Bootstrap/DataTables appearance */
...
.theme-dark .form-control,.theme-dark .form-select{background:#0f1827;color:#edf3fb;border-color:#2b3a51}.theme-dark .form-control::placeholder{color:#7f8da3}
...
<link rel="stylesheet" href="<?= base_url('assets/css/admin-booksto-inspired.css'); ?>">
