...
class Product extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->helper(array('url','product'));
    ...
    public function details($id = null) {
        ...
        $wish=$this->session->userdata('wishlist_ids');if(!is_array($wish))$wish=[];$data['wishlistCount']=count($wish);$data['isWishlisted']=in_array((int)$data['product']['id'],array_map('intval',$wish),true);
        $this->load->view('partials/navbar', $data);
