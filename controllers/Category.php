...
class Category extends CI_Controller {
    ...
    public function index() {
        ...
        $wish=$this->session->userdata('wishlist_ids');if(!is_array($wish))$wish=[];$wish=array_flip(array_map('intval',$wish));$data['wishlistStatus']=$wish;$data['wishlistCount']=count($wish);
